...
class ChapterController extends Controller{
    ...
    public function index($bookid,$num) {
        ...
        if(!empty($_GET['prid'])){
            setcookie("prid",$_GET['prid'],time()+86400,"/",".sjnovel.com");
            $prid=$_COOKIE['prid'];
           // echo $prid;
 ...
 //更新用户点击
    ...
    public function anzhang($books, $content) {
        ...
        if ($is != 1) {
            ...
            //购买成功产生记录
            $this->jilubiao($books[book_id], $content[the_price], "购买：$books[book_name]：$content[title]");
            //添加购买次数
    ...
    public function anben($books) {
        ...
        if ($is != 1) {
            ...
            //购买成功产生记录
            $this->jilubiao($books[book_id], $books[money], "整本购买：$books[book_name]");
        }
    }
