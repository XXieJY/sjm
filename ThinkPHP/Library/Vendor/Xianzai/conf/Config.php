<?php
     ...
     */
    class Config{
        static $appId="1475146729331525";//商户的应用ID
        static $secure_key="GOl2dZGSofyOmKXUGKoLVsSXmrWkxF0S";//商户的秘钥
        static $timezone="Asia/Shanghai";//时间时区
        static $trade_time_out="3600";
        static $front_notify_url="http://m.sjnovel.com/Home/Pay/index.html";
        static $back_notify_url="http://m.sjnovel.com/Home/Notify/index.html";
